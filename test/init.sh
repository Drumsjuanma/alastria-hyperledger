  ...
  cli_alastria:
	...
	services:
	  ...
	  peer0.'$DOMAIN'.alastria.com:
	    ...
	    volumes:
	        - /var/run/:/host/var/run/
	        - ./upscale/channel-artifacts/crypto-config/peerOrganizations/'$DOMAIN'.alastria.com/peers/peer0.'$DOMAIN'.alastria.com/msp:/etc/hyperledger/fabric/msp
	        - ./upscale/channel-artifacts/crypto-config/peerOrganizations/'$DOMAIN'.alastria.com/peers/peer0.'$DOMAIN'.alastria.com/tls:/etc/hyperledger/fabric/tls
